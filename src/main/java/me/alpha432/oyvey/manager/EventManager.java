...
import me.alpha432.oyvey.features.modules.client.PopCounterRewrite;
...
//            }
    ...
    public void onTick() {
        ...
        for (PlayerEntity player : mc.world.getPlayers()) {
            ...
            PopCounterRewrite.getInstance().onDeath(player);
        }
    }
    ...
    public void onPacketReceive(PacketEvent.Receive event) {
        ...
        PopCounterRewrite.getInstance().onTotemPop(mc.player);
