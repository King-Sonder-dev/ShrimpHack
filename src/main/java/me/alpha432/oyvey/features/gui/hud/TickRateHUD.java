...
public class TickRateHUD {
    private final Setting<Boolean> tickRate = new Setting<>("TickRate", false);
    private final Setting<Integer> yCoords = new Setting<>("Ycoords", 2, 0, 485, v -> tickRate.getValue());
    private final Setting<Integer> xCoords = new Setting<>("Xcoords", 2, 0, 710, v -> tickRate.getValue());
