...
import me.alpha432.oyvey.event.impl.EventListener;
...
public class CrasherModule extends Module {
    ...
    public CrasherModule() {
        super("POPlag", "", Module.Category.MISC, true, false, false);
    }
    public Setting<CrasherMode> modeConfig = this.register(new Setting<>("Mode", CrasherMode.ARMOR));
