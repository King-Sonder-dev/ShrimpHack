...
public class HUD extends Module {
    ...
    private static final ItemStack totem = new ItemStack(Items.TOTEM_OF_UNDYING);
        ...
        private final Setting<String> customGreeter = this.register(new Setting<String>("GreeterCustom", "Oyvey++", v -> this.greetermode.getValue() == Greeter.CUSTOM));
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        int widthGreeter = mc.getWindow().getScaledWidth();
            ...
            switch (this.greetermode.getValue()) {
                case CHRISTMAS: {
                    text = "Oyvey++ " + "time remove" + HUD.mc.player.getDisplayName().getString() + " :^)";
                    break;
                }
            }
            switch (this.greetermode.getValue()) {
                case LONG: {
                    text = "Welcome to Oyvey++ " + HUD.mc.player.getDisplayName().getString() + " :^)";
                    break;
                }
            }
            switch (this.greetermode.getValue()) {
