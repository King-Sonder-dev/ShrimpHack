package aids.dev.shrimphack.util.Text;

import com.google.common.collect.Sets;

import java.util.Set;

public class BaitUtil {
    public static final Set<String> SEX_SCRIPT = Sets.newHashSet(
    ...
    public static final Set<String> SPIKE_AND_KIDS = Sets.newHashSet(
    ...
    public static final Set<String> PKBAIT = Sets.newHashSet(
            "LETS GO PK VC LOL",
            "LETS BLAZE NN",
            "WHO ARE YOU",
            "IM IN HYPERION VC",
