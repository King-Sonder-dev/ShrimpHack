package aids.dev.shrimphack.util.Robot;

import aids.dev.shrimphack.util.Math.Vec3;
...
public class AStarCustomPathFinder implements Util {
   ...
   private static boolean isBlockSolid(BlockPos block) {
      ...
      return blockState.isFullCube(mc.world, block) || blockState.getBlock() instanceof SlabBlock || blockState.getBlock() instanceof StairsBlock || blockState.getBlock() instanceof CactusBlock || blockState.getBlock() instanceof ChestBlock || blockState.getBlock() instanceof EnderChestBlock || blockState.getBlock() instanceof SkullBlock || blockState.getBlock() instanceof PaneBlock || blockState.getBlock() instanceof FenceBlock || blockState.getBlock() instanceof WallBlock || blockState.getBlock() instanceof StainedGlassBlock || blockState.getBlock() instanceof PistonBlock || blockState.getBlock() instanceof PistonExtensionBlock || blockState.getBlock() instanceof PistonHeadBlock || blockState.getBlock() instanceof TrapdoorBlock;
   }
