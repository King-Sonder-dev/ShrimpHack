package aids.dev.shrimphack.features.gui;

import aids.dev.shrimphack.features.Feature;
import aids.dev.shrimphack.features.gui.items.Item;
import aids.dev.shrimphack.features.gui.items.buttons.ModuleButton;
import aids.dev.shrimphack.features.gui.snow.Snow;
...
public class ShrimpHackGui extends Screen {
    private static ShrimpHackGui ShrimphackGui;
    private static ShrimpHackGui INSTANCE;
    private float scrollY;
    static {
        INSTANCE = new ShrimpHackGui();
    }
    ...
    public ShrimpHackGui() {
        super(Text.literal("Shrimphack"));
        setInstance();
        load();
    }

    public static ShrimpHackGui getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new ShrimpHackGui();
        }
        return INSTANCE;
    ...
    public static ShrimpHackGui getClickGui() {
        return ShrimpHackGui.getInstance();
    }
