...
import aids.dev.shrimphack.features.modules.movement.autosprint.util.MovementUtility;
...
public class AutoSprint extends Module {
    ...
    public AutoSprint() {
        super("AutoSprint", "AutoSprint lol", Category.MOVEMENT, true, false, false);
        this.setInstance();
    }
