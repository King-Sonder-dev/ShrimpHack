...
public class PvpInfoModule extends Module {
    ...
    public String getWatermark() {
        switch (textMode.getValue()) {
            ...
            case TROLLGOD:
                return "Trollgod.CC";
            case OYVEY:
                return Shrimphack.NAME + " " + Shrimphack.VERSION;
            case OYVEYDOTPUB:
                return "ShrimpHack.dev";
            case MIO:
                return "Mio v2.0.2";
            case MIONIGHTLY:
        ...
        if (player != null) {
            ...
            if (nearbyPlayers.isEmpty()) {
                ...
                for (PlayerEntity nearbyPlayer : nearbyPlayers) {
                    if (!Shrimphack.friendManager.isFriend(nearbyPlayer)) {
                        allFriends = false;
                        break;
                    }
                }
    ...
    private int getPing() {
        return Shrimphack.serverManager.getPing();
    }
