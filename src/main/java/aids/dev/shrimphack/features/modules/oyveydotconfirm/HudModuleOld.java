package aids.dev.shrimphack.features.modules.oyveydotconfirm;
...
public class HudModuleOld extends Module {
    public HudModuleOld() {
        super("HudOld", "hud", Category.SHRIMPDOTCONFIRM, true, false, false);
    }
    ...
    public void onRender2D(Render2DEvent event) {
        ...
        event.getContext().drawTextWithShadow(
                mc.textRenderer,
                this.watermark.getValue() + " " + Shrimphack.VERSION,
        ...
        if (speed.getValue()) {
            event.getContext().drawTextWithShadow(
                    mc.textRenderer,
                    "Speed: " + Shrimphack.speedManager.getSpeedMpS(),
