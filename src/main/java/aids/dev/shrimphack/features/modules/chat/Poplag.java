...
public class Poplag extends Module {
    ...
    private final Setting<Boolean> popevent = this.register(new Setting<Boolean>("PopEvent", true));
    ...
    private final Setting<Boolean> poplag = this.register(new Setting<Boolean>("PopLag", true, v -> this.popevent.getValue()));



    public Poplag() {
        super("Poplag", "ezzzz kits noobs", Category.CHAT, true, false, false);
    }
