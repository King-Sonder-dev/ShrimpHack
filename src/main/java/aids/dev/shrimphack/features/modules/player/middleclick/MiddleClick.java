package aids.dev.shrimphack.features.modules.player.middleclick;

import aids.dev.shrimphack.Shrimphack;
import aids.dev.shrimphack.event.impl.autototem.EventSync;
...
import aids.dev.shrimphack.features.modules.player.middleclick.util.Timer;
...
public class MiddleClick extends Module {
    ...
    public MiddleClick() {
        super("MiddleClick", "MiddleClick", Category.MISC, true, false, false);
        this.setInstance();
    }
    ...
    private void onSync(EventSync event) {
        ...
        if (friend.getValue() && mc.currentScreen == null && mc.options.pickItemKey.isPressed() && mc.targetedEntity != null && mc.targetedEntity instanceof PlayerEntity entity && timer.passedMs(800)) {
            if (Shrimphack.friendManager.isFriend(entity.getName().getString())) {
                Shrimphack.friendManager.removeFriend(entity.getName().getString());
                sendMessage("§b" + entity.getName().getString() + "§r removed from friends!");
            } else {
                Shrimphack.friendManager.addFriend(entity.getName().getString());
