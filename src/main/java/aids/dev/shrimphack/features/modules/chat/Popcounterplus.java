...
public class Popcounterplus extends Module {
    ...
    public Popcounterplus() {
        super("Popcounterplus", "ezzzz kits noobs", Category.CHAT, true, false, false);
    }
    @Subscribe
    ...
    private String getDeathMessage(String playerName, int pops) {
        switch (this.popNotifier.getValue()) {
            ...
            case DOTGOD:
                return Formatting.DARK_PURPLE + "[" + Formatting.LIGHT_PURPLE + "DotGod.CC" + Formatting.DARK_PURPLE + "] " + Formatting.LIGHT_PURPLE + playerName + " died after popping " + Formatting.GREEN + pops + Formatting.LIGHT_PURPLE + " times in total!";
            case SN0W:
